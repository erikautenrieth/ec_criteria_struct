...
#SBATCH --output=log/llama3_70b_inst_5_shot.%j.out   # Standard output and error log
#SBATCH --error=log/llama3_70b_inst_5_shot.%j.err    # Error log
#SBATCH --job-name=llama3_70b_inst_5_shot
