...
model_desc = read_text_file(f"{transform_chia}/chia_label/prompts/model_desc_p1.txt")


# Load n-shot Data
study_folder = f"{transform_chia}/input/half_clinical_trials/" 
label_folder = f'{transform_chia}/chia_label/p1_model_input' 
