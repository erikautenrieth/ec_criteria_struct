...
batch_path = "lora_70b_pr2_temp"

model_id = "tuned_models_70b/llama3_70b_Lora_ep10_r256"
...
for temp in np.arange(0.1, 1.1, 0.1):
    ...
    model_name = f"70b_EP10_r256_temp{str(temp)}"
    ...
    for file in study_files:
        ...
        outputs = model.generate(**inputs, max_new_tokens=2048, use_cache=True, temperature=temp) #  temperature=0.5
