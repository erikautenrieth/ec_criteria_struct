...
model_desc = read_text_file(f"{transform_lct}/input/prompt/claude_prompt.txt")
study_path = f"{transform_lct}/input/lct_txt/"
output_path = f"{transform_lct}/evaluate_parse_1/{batch_path}/model_output/{model_name}_{n_shot}_shot_prompt__claude{temp_str}{cot_true}/output/"
