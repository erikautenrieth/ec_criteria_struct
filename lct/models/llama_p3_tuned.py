...
output_path = f"{transform_lct}/evaluate/{batch_path}/model_output/{model_name}_p{n_prompt}/output/"
...
command = read_text_file(f"{transform_lct}/input/prompt/entity_struct_p1.txt")
