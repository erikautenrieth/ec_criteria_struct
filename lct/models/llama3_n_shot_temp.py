...
for temp in np.arange(0.1, 1.1, 0.1):
    ...
    model_name = f"Llama-3-70B"
    output_path = f"{transform_lct}/evaluate_parse_1/{batch_path}/model_output/{model_name}_{n_shot}_shot_max_{str(temp)}/output/"
