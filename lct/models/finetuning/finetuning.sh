...
#SBATCH --output=70b_e10_r128_a512.%j.out   # Standard output and error log
#SBATCH --error=70b_e10_r128_a512.%j.err    # Error log  p1_8b_e10_r2048.%j.err 
#SBATCH --job-name=tune8b

module load cuda
export CUDA_VISIBLE_DEVICES=0 

python finetune_llama3_p1_70b.py  # finetune_llama3_p1_70b.py
