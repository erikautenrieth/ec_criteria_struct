...
#SBATCH --output=70b_tunep4_40ep_linear.%j.out   # Standard output and error log
#SBATCH --error=70b_tunep4_40ep_linear.%j.err    # Error log  p1_8b_e10_r2048.%j.err 
#SBATCH --job-name=70b_tune

module load cuda
export CUDA_VISIBLE_DEVICES=0 

python finetune_llama3_70b_p1.py
