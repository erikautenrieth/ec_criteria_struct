...
#SBATCH --output=8b_e10_r256.%j.out   # Standard output and error log
#SBATCH --error=8b_e10_r256.%j.err    # Error log  p1_8b_e10_r2048.%j.err 
#SBATCH --job-name=tune_p1

module load cuda
export CUDA_VISIBLE_DEVICES=0 

python finetune_llama3_8b_p1.py # finetune_llama3_p1_70b.py
