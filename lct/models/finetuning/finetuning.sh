...
#SBATCH --gres=gpu:4 
#SBATCH --time=42:00:00          # Time limit hrs:min:sec
#SBATCH --nodelist=wr24          # Specify the node 20 (fail), 21, (geht) 22 (geht), 23 (geht), 24 (fail) ,25 (geht) !
#SBATCH --output=p1_70b_e40_r128.%j.out   # Standard output and error log
#SBATCH --error=p1_70b_e40_r128.%j.err    # Error log  p1_8b_e10_r2048.%j.err 
#SBATCH --job-name=tune70b

module load cuda
export CUDA_VISIBLE_DEVICES=0 

python finetune_llama3_p1_70b.py
