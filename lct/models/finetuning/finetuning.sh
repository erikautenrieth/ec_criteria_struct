...
#SBATCH --output=70b_e10_r256_lin.%j.out   # Standard output and error log
#SBATCH --error=70b_e10_r256_lin.%j.err    # Error log  p1_8b_e10_r2048.%j.err 
#SBATCH --job-name=tune_p1

module load cuda
export CUDA_VISIBLE_DEVICES=0 

python finetune_llama3_70b_p1.py # finetune_llama3_p1_70b.py
