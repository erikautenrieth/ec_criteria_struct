...
model_id = "tuned_models/llama3_70b_LoRA_struct2_prompt2ep10"
model_name = "Llama3_70b_Fine-Tuned_struct2_prompt2ep10"
...
command = read_text_file(f"{transform_lct}/input/prompt/entity_struct_p2.txt")
